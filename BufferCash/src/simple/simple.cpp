...
BEGIN_MESSAGE_MAP(CsimpleApp, CWinAppEx)
...
// CsimpleApp customization load/save methods

void CsimpleApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CsimpleApp::LoadCustomState()
{
}

void CsimpleApp::SaveCustomState()
{
}